...
program
    .command('compile-auction-contract')
    .action(contract.compileAuctionContract);
program
    .command('deploy-auction-contract')
    .action(contract.deployAuctionContract);
program
    .command('configure-auction-contract')
    .action(contract.configureAuction);
program
    .command('add-admin-to-mint')
    .action(contract.addAdmin);
program
    .command('remove-admin-to-mint')
    .action(contract.removeAdmin);
program
    .command('activate-accounts')
    .action(bootstrap.activateAccounts);
program
    .command('mint-token')
    .action(contract.mintToken);
program
    .command('deposit')
...
//# sourceMappingURL=d-art.contracts.js.map